  ...
  return (
    ...
    <AppBar position='relative' color='default' style={{marginBottom: theme.spacing(6), transition: 'background-color 4s ease'}}>
       <Toolbar  style={{display: 'flex', alignContent: 'center', alignItems: 'center', justifyContent: 'space-between'}}>
        <Typography variant='h5' style={{transition: 'color 4s ease'}}>Player searches</Typography>
         <Typography variant='body1'>Use dark mode?<Switch color='primary' checked={isDarkTheme} onChange={() => {setIsDarkTheme(!isDarkTheme)}}/></Typography>
       </Toolbar>
     </AppBar>
    <CardList/>
   </Container>
